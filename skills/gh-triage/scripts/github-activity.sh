#!/usr/bin/env bash
# Summarize a GitHub login's recent activity in a repo and (optionally) globally.
#
# Adapted from https://github.com/steipete/agent-scripts/blob/main/skills/github-project-triage/scripts/github-activity.sh
# by Peter Steinberger (MIT). Only change: repo is required, no implicit default.
set -euo pipefail
